...
import BooberCardBody from './BooberCardBody';
...
const PreviewCode = () => {
  return (
    <Row>
      <Col>
        <Nav variant="pills" className="nav-pills-Boober m-0">
          <Nav.Item>
...
const BooberComponentCardHeader = ({
  light,
  className,
  title,
  children,
...
BooberComponentCard.Header = BooberComponentCardHeader;
BooberComponentCard.Body = BooberCardBody;

BooberComponentCard.propTypes = {
  children: PropTypes.node,
  multiSections: PropTypes.bool,
  noGuttersBottom: PropTypes.bool
};

BooberComponentCardHeader.propTypes = {
...
export default BooberComponentCard;
