...
const Alerts = () => (
  <>
    ...
    <BooberComponentCard>
      <BooberComponentCard.Header title="Alerts with icon" />
    ...
    <BooberComponentCard>
      <BooberComponentCard.Header title="Basic Examples">
        <p className="mb-0">
      ...
      <BooberComponentCard.Body code={alertCode} language="jsx" />
    </BooberComponentCard>

    <BooberComponentCard>
      <BooberComponentCard.Header title="Links">
        <p className="mb-0">
          For links, use the <code>{` <Alert.Link> `}</code> component to
          provide matching colored links within any alert.
        </p>
      </BooberComponentCard.Header>
      <BooberComponentCard.Body code={linkCode} language="jsx" />
    </BooberComponentCard>

    <BooberComponentCard>
      <BooberComponentCard.Header title="Additional content">
        <p className="mb-0">
          Add the <code>dismissible</code> prop to add a functioning dismiss
          button to the Alert.
        </p>
      </BooberComponentCard.Header>
      <BooberComponentCard.Body code={additionalContentCode} language="jsx" />
    </BooberComponentCard>

    <BooberComponentCard multiSections>
      <Tab.Container defaultActiveKey="preview">
        <BooberComponentCard.Header title="Dismissing">
          <p className="mb-0">
            Alerts can contain whatever content you like. Headers, paragraphs,
            dividers, go crazy.
          </p>
        </BooberComponentCard.Header>
        <BooberComponentCard.Body code={dismissCodeOne} language="jsx" />
      </Tab.Container>
      <Tab.Container defaultActiveKey="preview">
        <BooberComponentCard.Header>
          <p className="mb-0">
        ...
        <BooberComponentCard.Body code={dismissCodeTwo} language="jsx" />
      </Tab.Container>
    </BooberComponentCard>
  </>
);
