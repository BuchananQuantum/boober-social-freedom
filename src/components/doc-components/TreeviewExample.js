    ...
    <>
      ...
      <Card className="mb-3">
        ...
        <Card.Body className="pt-0">
          <BooberEditor code={propTypessCode} language="jsx" hidePreview />
        </Card.Body>
      </Card>

      <Card className="mb-3">
        <BooberComponentCard.Header title="Treeview Item Structure" noPreview />
        <Card.Body className="pt-0">
          <BooberEditor code={objectCode} language="jsx" hidePreview />
        </Card.Body>
      </Card>
      ...
      <BooberComponentCard>
        <BooberComponentCard.Header title="Select Example" />
        <BooberComponentCard.Body
          code={selectionCode}
          scope={{ Treeview }}
          language="jsx"
