...
const FileUploader = () => (
  <>
    <PageHeader
      title="File Uploader"
      description="Boober uses <strong>React Dropzone</strong> for file-uploader. <strong>React Dropzone</strong> provides a simple react hook to create a HTML5-compliant drag'n'drop zone for files."
      className="mb-3"
    >
      <Button
    ...
    <BooberComponentCard>
      <BooberComponentCard.Header title="Single File Upload" light={false} />
      <BooberComponentCard.Body
        code={singleFileCode}
        language="jsx"
        scope={{ useDropzone, Flex, cloudUpload }}
    ...
    <BooberComponentCard>
      <BooberComponentCard.Header title="Image Preview" light={false} />
      <BooberComponentCard.Body
        code={previewCode}
        language="jsx"
