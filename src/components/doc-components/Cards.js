...
const Card = () => {
  return (
    <>
      <PageHeader
        title="Cards"
        description="Boober’s cards provide a flexible and extensible content container with multiple variants and options."
        className="mb-3"
      >
        <Button
      ...
      <Row className="g-3 mb-3">
        <Col>
          <BooberComponentCard className="h-100">
        ...
        <Col>
          <BooberComponentCard className="h-100">
            <BooberComponentCard.Header title="Card with list" light={false} />
            <BooberComponentCard.Body
      ...
      <BooberComponentCard>
        <BooberComponentCard.Header title="Card with image" light={false} />
        <BooberComponentCard.Body
      ...
      <BooberComponentCard>
        <BooberComponentCard.Header title="Notification" light={false} />
        <BooberComponentCard.Body
      ...
      <BooberComponentCard>
        <BooberComponentCard.Header title="Card Groups" light={false} />
        <BooberComponentCard.Body
          code={cardGroupCode}
          language="jsx"
      ...
      <BooberComponentCard>
        <BooberComponentCard.Header title="Card Styles" light={false}>
          <p className="mb-0">
