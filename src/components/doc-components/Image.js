...
const Images = () => (
  <>
    ...
    <BooberComponentCard>
      <BooberComponentCard.Header title="Shape" light={false}>
    ...
    <BooberComponentCard>
      <BooberComponentCard.Header title="Fluid" light={false}>
        <p className="mt-2 mb-0">
    ...
    <BooberComponentCard>
      <BooberComponentCard.Header title="Aligning images" light={false} />
      <BooberComponentCard.Body
        code={aligningCode}
