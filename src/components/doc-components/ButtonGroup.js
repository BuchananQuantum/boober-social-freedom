...
const ButtonGroup = () => (
  <>
    ...
    <BooberComponentCard>
      <BooberComponentCard.Header title="Button toolbar" light={false}>
        <p className="mb-0">
          Combine sets of <code>&lt;ButtonGroup&gt;</code>s into a{' '}
          <code>&lt;ButtonToolbar&gt;</code> for more complex components.
        </p>
      </BooberComponentCard.Header>
      <BooberComponentCard.Body code={btnToolbarCode} language="jsx" />
    </BooberComponentCard>
    ...
    <BooberComponentCard>
      ...
      <BooberComponentCard.Body code={inputGroupExampleCode} language="jsx" />
    </BooberComponentCard>
    ...
    <BooberComponentCard>
      <BooberComponentCard.Header title="Nesting" light={false}>
        <p className="mb-0">
      ...
      <BooberComponentCard.Body code={nestingCode} language="jsx" />
    </BooberComponentCard>

    <BooberComponentCard>
      <BooberComponentCard.Header title="Vertical variation" light={false}>
        <p className="mb-0">
      ...
      <BooberComponentCard.Body code={verticalVariationCode} language="jsx" />
    </BooberComponentCard>

    <BooberComponentCard>
      <BooberComponentCard.Header title="Checkbox / Radio" light={false}>
        <p className="mb-0">
      ...
      <BooberComponentCard.Body code={toggleBtnCode} language="jsx" />
    </BooberComponentCard>

    <BooberComponentCard>
      <BooberComponentCard.Header title="Uncontrolled" light={false}>
        <p className="mb-0">
      ...
      <BooberComponentCard.Body code={unControlledCode} language="jsx" />
    </BooberComponentCard>

    <BooberComponentCard>
      <BooberComponentCard.Header title="Controlled" light={false} />
      <BooberComponentCard.Body code={controlledCode} language="jsx" />
    </BooberComponentCard>
  </>
);
