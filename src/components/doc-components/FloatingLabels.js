...
const FloatingLabels = () => (
  <>
    ...
    <BooberComponentCard>
      <BooberComponentCard.Header title="Textareas" light={false}>
        <p className="mt-2 mb-0">
      ...
      <BooberComponentCard.Body code={textAreaCodes} language="jsx" />
    </BooberComponentCard>

    <BooberComponentCard>
      <BooberComponentCard.Header title="Validation" light={false}>
        <p className="mt-2 mb-0">
          Use <code>isValid</code> or <code>isInvalid</code> props for
          validation.
        </p>
      </BooberComponentCard.Header>
      <BooberComponentCard.Body code={validationCode} language="jsx" />
    </BooberComponentCard>

    <BooberComponentCard>
      <BooberComponentCard.Header title="Selects" light={false}>
        <p className="mt-2 mb-0">
      ...
      <BooberComponentCard.Body code={selectsCode} language="jsx" />
    </BooberComponentCard>

    <BooberComponentCard>
      <BooberComponentCard.Header title="Layout" light={false}>
        <p className="mt-2 mb-0">
          When working with the Bootstrap grid system, be sure to place form
          elements within column classes.
        </p>
      </BooberComponentCard.Header>
      <BooberComponentCard.Body code={layoutCode} language="jsx" />
    </BooberComponentCard>

    <BooberComponentCard>
      <BooberComponentCard.Header title="Customizing rendering" light={false}>
        <p className="mt-2 mb-0">
      ...
      <BooberComponentCard.Body code={customizingRenderCode} language="jsx" />
    </BooberComponentCard>
  </>
);
