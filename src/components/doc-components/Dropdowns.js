...
const exampleCode = `
<Dropdown>
  <Dropdown.Toggle variant="Boober-default">
    Dropdown
  </Dropdown.Toggle>
...
<DropdownButton id="dropdown-basic-button" title="Dropdown button" variant='Boober-default'>
  <Dropdown.Item href="#/action-1">Action</Dropdown.Item>
  <Dropdown.Item href="#/action-2">Another action</Dropdown.Item>
  <Dropdown.Item href="#/action-3">Something else</Dropdown.Item>
  <Dropdown.Divider />
...
const Dropdowns = () => (
  <>
    ...
    <Row className="g-3">
      ...
      <Col>
        <BooberComponentCard>
          <BooberComponentCard.Header title="Dropwdown Button" light={false} />
          <BooberComponentCard.Body code={dropdownBtnCode} language="jsx" />
        </BooberComponentCard>
      </Col>
    </Row>

    <BooberComponentCard>
      <BooberComponentCard.Header title="Button Variant" light={false} />
      <BooberComponentCard.Body code={btnVariantCode} language="jsx" />
    </BooberComponentCard>

    <BooberComponentCard>
      <BooberComponentCard.Header title="Split Button Code" light={false} />
      <BooberComponentCard.Body code={splitBtnCode} language="jsx" />
    </BooberComponentCard>
    ...
    <BooberComponentCard>
      <BooberComponentCard.Header title="Directions" light={false} />
      <BooberComponentCard.Body code={directionCode} language="jsx" />
    </BooberComponentCard>

    <BooberComponentCard>
      <BooberComponentCard.Header title="Dropdown items" light={false}>
      ...
      <BooberComponentCard.Body code={dropdownItemsCode} language="jsx" />
    </BooberComponentCard>

    <BooberComponentCard>
      <BooberComponentCard.Header title="Menu alignment" light={false}>
      ...
      <BooberComponentCard.Body code={menuAlignMentCode} language="jsx" />
    </BooberComponentCard>

    <BooberComponentCard>
      <BooberComponentCard.Header title="Responsive alignment" light={false}>
        <p className="mt-2 mb-0">
      ...
      <BooberComponentCard.Body code={responsiveAlignmentCode} language="jsx" />
    </BooberComponentCard>

    <Row className="g-3 mb-3">
      <Col>
        <BooberComponentCard>
          <BooberComponentCard.Header title="Dropwdown Headers" light={false} />
          <BooberComponentCard.Body code={headerCode} language="jsx" />
        </BooberComponentCard>
      </Col>
      <Col>
        <BooberComponentCard>
          <BooberComponentCard.Header title="Dropwdown Divider" light={false} />
          <BooberComponentCard.Body code={dividerCode} language="jsx" />
        </BooberComponentCard>
      </Col>
    </Row>
  </>
