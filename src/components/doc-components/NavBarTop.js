...
const NavBarTop = () => {
  ...
  return (
    <>
      <PageHeader
        title="Navbar Top"
        description="Navbar Top is a different user friendly layout system in Boober. You can start developing with Navbar Top layout with the starter page."
        className="mb-3"
      >
        <Button
          onClick={() =>
      ...
      <Card className="mb-3">
        <BooberCardHeader title="Supported Content" light={false} />
        <Card.Body className="bg-light">
          <p>
            Boober Navbar Top support all of
      ...
      <Card className="mb-3">
        <BooberCardHeader title="Behaviors" light={false} />
        <Card.Body className="bg-light">
          <p>
            Boober Navbar Top uses
            <a href={`${reactBootstrapDocsUrl}/components/navbar/`}>
              {' '}
              React-Bootstrap Navbar{' '}
            </a>
            responsive behaviors and all other behavior they support. The
            dropdown menu display onClick by default on react-bootstrap. Boober
      ...
      <Card className="mb-3">
        <BooberCardHeader title="Color Schemes" light={false} />
        <Card.Body className="bg-light">
          <p>
            Changing the color of Boober Navbar Top is very easy. Boober uses
