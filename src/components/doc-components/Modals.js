    ...
    <>
      ...
      <Modal show={show} onHide={handleClose} backdrop="static" keyboard={false}>
        <Modal.Header>
          ...
          <BooberCloseButton onClick={handleClose}/>
        </Modal.Header>
        <Modal.Body>
    ...
    <>
      ...
      >
        <Modal.Header>
          ...
          <BooberCloseButton onClick={() => setSmShow(false)}/>
        </Modal.Header>
      ...
      >
        <Modal.Header>
          ...
          <BooberCloseButton onClick={() => setLgShow(false)}/>
        </Modal.Header>
        <Modal.Body>...</Modal.Body>
      </Modal>
    </>
...
const Modals = () => (
  <>
      ...
      <Col lg={6}>
        <BooberComponentCard noGuttersBottom>
          <BooberComponentCard.Header
            ...
            light={false}
          />
          <BooberComponentCard.Body code={customCloseBtnCode} language="jsx" />
        </BooberComponentCard>
      </Col>
    </Row>
    <BooberComponentCard>
      <BooberComponentCard.Header title="Static backdrop" light={false}>
      ...
      <BooberComponentCard.Body
        ...
        language="jsx"
        scope={{ BooberCloseButton }}
      />
    </BooberComponentCard>

    <BooberComponentCard>
      <BooberComponentCard.Header title="Tooltips and Popovers" light={false}>
        <p className="mb-0 mt-2">
    ...
    <BooberComponentCard>
      <BooberComponentCard.Header title="Optional Sizes" light={false}>
        <p className="mb-0 mt-2">
    ...
    <BooberComponentCard>
      <BooberComponentCard.Header title="Fullscreen Modal" light={false}>
        <p className="mb-0 mt-2">
      ...
      <BooberComponentCard.Body code={fullscreenCode} language="jsx" />
    </BooberComponentCard>
  </>
);
