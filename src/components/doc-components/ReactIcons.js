...
const ReactIcons = () => (
  <>
    ...
    <BooberComponentCard>
      <BooberComponentCard.Header title="Bootstrap Icons" light={false} />
    ...
    <BooberComponentCard>
      <BooberComponentCard.Header title="Feather Icons" light={false} />
      <BooberComponentCard.Body
    ...
    <BooberComponentCard>
      <BooberComponentCard.Header title="Material Icons" light={false} />
      <BooberComponentCard.Body
