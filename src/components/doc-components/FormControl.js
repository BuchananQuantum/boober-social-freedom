  ...
  <>
    ...
    <BooberComponentCard multiSections>
      <Tab.Container defaultActiveKey="preview">
        <BooberComponentCard.Header title="Readonly" light={false}>
          <p className="mt-2 mb-0">
        ...
        <BooberComponentCard.Body code={readOnlyCode} language="jsx" />
      </Tab.Container>
      <Tab.Container defaultActiveKey="preview">
        <BooberComponentCard.Header title="Readonly plain text" light={false}>
          <p className="mt-2 mb-0">
        ...
        <BooberComponentCard.Body code={readOnlyTextCode} language="jsx" />
      </Tab.Container>
    </BooberComponentCard>

    <BooberComponentCard>
      <BooberComponentCard.Header title="File Input" light={false} />
      <BooberComponentCard.Body code={fileInputCode} language="jsx" />
    </BooberComponentCard>

    <BooberComponentCard>
      <BooberComponentCard.Header title="File Input Sizing" light={false} />
      <BooberComponentCard.Body code={fileInputSizingCode} language="jsx" />
    </BooberComponentCard>

    <BooberComponentCard>
      <BooberComponentCard.Header title="Datalist" light={false} />
      <BooberComponentCard.Body code={datalistCode} language="jsx" />
    </BooberComponentCard>
  </>
);
