...
const Placeholder = () => (
  <>
    ...
    <BooberComponentCard>
      <BooberComponentCard.Header title="Width">
        <p className="mt-2 mb-0">
          You can change the <code>width</code> through grid column classes,
          width utilities, or inline styles.
        </p>
      </BooberComponentCard.Header>
      <BooberComponentCard.Body code={widthCode} language="jsx" />
    </BooberComponentCard>

    <BooberComponentCard>
      <BooberComponentCard.Header title="Color">
        <p className="mt-2 mb-0">
      ...
      <BooberComponentCard.Body code={colorCode} language="jsx" />
    </BooberComponentCard>

    <BooberComponentCard>
      <BooberComponentCard.Header title="Sizing">
        <p className="mt-2 mb-0">
    ...
    <BooberComponentCard>
      <BooberComponentCard.Header title="Animation">
        <p className="mt-2 mb-0">
      ...
      <BooberComponentCard.Body code={animationCode} language="jsx" />
    </BooberComponentCard>
  </>
);
