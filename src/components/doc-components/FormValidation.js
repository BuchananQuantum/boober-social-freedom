...
const FormValidation = () => (
  <>
    ...
    <BooberComponentCard>
      <BooberComponentCard.Header title="Tooltips" light={false}>
      ...
      <BooberComponentCard.Body code={tooltipsCode} language="jsx" />
    </BooberComponentCard>

    <BooberComponentCard>
      <BooberComponentCard.Header title="Input group validation" light={false}>
        <p className="mt-2 mb-0">
