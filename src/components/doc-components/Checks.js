...
const Checks = () => (
  <>
    ...
    <BooberComponentCard>
      <BooberComponentCard.Header title="Checks" light={false} />
      <BooberComponentCard.Body code={checksExampleCode} language="jsx" />
    </BooberComponentCard>

    <BooberComponentCard>
      <BooberComponentCard.Header title="Radios" light={false} />
      <BooberComponentCard.Body code={radioExampleCode} language="jsx" />
    </BooberComponentCard>

    <BooberComponentCard>
      <BooberComponentCard.Header title="Switches" light={false} />
      <BooberComponentCard.Body code={switchesCode} language="jsx" />
    </BooberComponentCard>

    <BooberComponentCard>
      <BooberComponentCard.Header title="Check Inline" light={false} />
      <BooberComponentCard.Body code={inlineCheckboxCode} language="jsx" />
    </BooberComponentCard>

    <BooberComponentCard>
      <BooberComponentCard.Header title="Radio Inline" light={false} />
      <BooberComponentCard.Body code={inlineRadioCode} language="jsx" />
    </BooberComponentCard>

    <BooberComponentCard>
      <BooberComponentCard.Header title="Custom rendering" light={false}>
        <p className="mt-2">
      ...
      <BooberComponentCard.Body code={customRenderCode} language="jsx" />
    </BooberComponentCard>
  </>
);
