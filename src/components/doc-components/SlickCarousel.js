...
const SlickCarousel = () => (
  <>
    <PageHeader
      ...
      description="Boober-React uses <strong>React Slick</strong> for advance carousel experience. <strong>React slick</strong> is a carousel component built with React. It is a react port of  slick carousel"
      className="mb-3"
    >
      <Button
