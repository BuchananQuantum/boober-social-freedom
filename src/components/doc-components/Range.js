...
const Range = () => (
  <>
    ...
    <BooberComponentCard>
      <BooberComponentCard.Header title="Overview" light={false}>
    ...
    <BooberComponentCard>
      <BooberComponentCard.Header title="Min and max" light={false}>
        <p className="mt-2 mb-0">
      ...
      <BooberComponentCard.Body code={minmaxCode} language="jsx" />
    </BooberComponentCard>

    <BooberComponentCard>
      <BooberComponentCard.Header title="Steps" light={false}>
        <p className="mt-2 mb-0">
      ...
      <BooberComponentCard.Body code={stepsCode} language="jsx" />
    </BooberComponentCard>
  </>
);
