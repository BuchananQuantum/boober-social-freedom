...
const InputGroup = () => (
  <>
    ...
    <BooberComponentCard>
      <BooberComponentCard.Header title="Checkboxes and radios" light={false}>
        <p className="mt-2 mb-0">
          Use the <code>InputGroup.Radio</code> or{' '}
          <code>InputGroup.Checkbox</code> to add options to an input group.
        </p>
      </BooberComponentCard.Header>
      <BooberComponentCard.Body code={checkboxesCode} language="jsx" />
    </BooberComponentCard>

    <BooberComponentCard>
      <BooberComponentCard.Header title="Multiple inputs" light={false}>
        <p className="mt-2 mb-0">
          While multiple inputs are supported visually, validation styles are
          only available for input groups with a single input.
        </p>
      </BooberComponentCard.Header>
      <BooberComponentCard.Body code={multipleInputCode} language="jsx" />
    </BooberComponentCard>

    <BooberComponentCard>
      <BooberComponentCard.Header title="Multiple addons" light={false}>
        <p className="mt-2 mb-0">
          Multiple add-ons are supported and can be mixed with checkbox and
          radio input versions.
        </p>
      </BooberComponentCard.Header>
      <BooberComponentCard.Body code={multipleAddonsCode} language="jsx" />
    </BooberComponentCard>

    <BooberComponentCard>
      <BooberComponentCard.Header title="Button addons" light={false} />
      <BooberComponentCard.Body code={buttonAddOnsCode} language="jsx" />
    </BooberComponentCard>
    ...
    <BooberComponentCard>
      <BooberComponentCard.Header
        ...
        light={false}
      />
      <BooberComponentCard.Body code={buttonsWithDropdowsCode} language="jsx" />
    </BooberComponentCard>

    <BooberComponentCard>
      <BooberComponentCard.Header title="Segmented buttons" light={false} />
      <BooberComponentCard.Body code={segmentedButtonsCode} language="jsx" />
    </BooberComponentCard>
  </>
);
