...
const Tabs = () => (
  <>
    ...
    <Row className="mb-3 g-3">
      <Col md={6}>
        <BooberComponentCard noGuttersBottom>
          <BooberComponentCard.Header title="No animation" light={false}>
            <p className="mt-2 mb-0">
              Set the <code>transition</code> prop to <code>false</code>
            </p>
          </BooberComponentCard.Header>
          <BooberComponentCard.Body code={NoAnimationCode} language="jsx" />
        </BooberComponentCard>
      </Col>
      <Col md={6}>
        <BooberComponentCard noGuttersBottom>
    ...
    <BooberComponentCard>
      <BooberComponentCard.Header title="Custom Tab Layout" light={false}>
        <p className="mt-2">
      ...
      <BooberComponentCard.Body code={customLayoutCode} language="jsx" />
    </BooberComponentCard>
  </>
);
