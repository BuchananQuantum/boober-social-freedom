...
const TypedText = () => (
  <>
    <PageHeader
      title="Typed Text"
      description="Boober uses <strong>react-typed</strong> for text typing animation. <strong>react-typed</strong> is a react component that wraps up the <strong>Typed.js</strong>. <strong>Typed.js</strong> is a library that types. Enter in any string, and watch it type at the speed you've set, backspace what it's typed, and begin a new sentence for however many strings you've set."
      className="mb-3"
    >
      <Button
