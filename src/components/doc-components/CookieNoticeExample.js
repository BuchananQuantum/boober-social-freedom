...
const CookieNoticeExample = () => {
  ...
  return (
    <>
      <PageHeader
        title="Cookie Notice"
        description="Boober React has a built-in notification component that allows users to notify cookie uses on the website."
        className="mb-3"
      >
        <Button
          variant="link"
      ...
      <BooberComponentCard>
        <BooberComponentCard.Header title="Example" light={false}>
          <p className="mb-0 mt-2">
            Boober React's Cookie Notice uses React-Bootstrap's "Toast" feature
