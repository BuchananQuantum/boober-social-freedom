...
const FormLayout = () => (
  <>
    ...
    <BooberComponentCard>
      <BooberComponentCard.Header title="Basic form" light={false} />
      <BooberComponentCard.Body code={basicFormCode} language="jsx" />
    </BooberComponentCard>

    <BooberComponentCard>
      <BooberComponentCard.Header title="Horizontal form" light={false} />
      <BooberComponentCard.Body code={horizontalFormCode} language="jsx" />
    </BooberComponentCard>
    ...
    <BooberComponentCard>
      ...
      <BooberComponentCard.Body code={horizontalSizingCode} language="jsx" />
    </BooberComponentCard>

    <BooberComponentCard>
      <BooberComponentCard.Header title="Form Grid Layout" light={false}>
        <p className="mt-2 mb-0">
          More complex layouts can also be created with the grid system.
        </p>
      </BooberComponentCard.Header>
      <BooberComponentCard.Body code={formGridLayout} language="jsx" />
    </BooberComponentCard>

    <BooberComponentCard>
      <BooberComponentCard.Header title="Grid - Column Sizing" light={false}>
        <p className="mt-2 mb-0">
      ...
      <BooberComponentCard.Body code={columnSizingCode} language="jsx" />
    </BooberComponentCard>

    <BooberComponentCard>
      <BooberComponentCard.Header title="Grid - Auto Sizing" light={false}>
        <p className="mt-2 mb-0">
      ...
      <BooberComponentCard.Body code={autoSizingCode} language="jsx" />
    </BooberComponentCard>

    <BooberComponentCard>
      <BooberComponentCard.Header title="Gutters" light={false}>
        <p className="mt-2 mb-0">
      ...
      <BooberComponentCard.Body code={guttersCode} language="jsx" />
    </BooberComponentCard>
  </>
);
