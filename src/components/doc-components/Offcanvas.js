...
const Offcanvas = () => (
  <>
    ...
    <BooberComponentCard>
      ...
      <BooberComponentCard.Body code={placementCode} language="jsx" noInline />
    </BooberComponentCard>

    <BooberComponentCard>
      <BooberComponentCard.Header title="Backdrop" light={false}>
        <p className="mb-0 mt-2">
      ...
      <BooberComponentCard.Body code={backdropCode} language="jsx" noInline />
    </BooberComponentCard>
  </>
);
