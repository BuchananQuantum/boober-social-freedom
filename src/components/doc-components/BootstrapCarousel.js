...
const Carousel = () => (
  <>
    ...
    <BooberComponentCard>
      <BooberComponentCard.Header title="Styled Carousel" light={false} />
      <BooberComponentCard.Body
    ...
    <BooberComponentCard>
      <BooberComponentCard.Header title="With Captions" light={false} />
      <BooberComponentCard.Body
    ...
    <BooberComponentCard>
      <BooberComponentCard.Header title="Crossfade" light={false}>
        <p className="mt-2 mb-0">
    ...
    <BooberComponentCard>
      <BooberComponentCard.Header title="Dark varian" light={false}>
        <p className="mt-2 mb-0">
