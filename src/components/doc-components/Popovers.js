...
const Popovers = () => (
  <>
    ...
    <BooberComponentCard>
      <BooberComponentCard.Header title="Overview" noPreview />
    ...
    <BooberComponentCard>
      <BooberComponentCard.Header title="Examples" light={false} />
      <BooberComponentCard.Body code={exampleCode} language="jsx" noInline />
    </BooberComponentCard>
    ...
    <BooberComponentCard>
      <BooberComponentCard.Header title="Disabled elements" light={false}>
        <p className="mt-2 mb-0">
      ...
      <BooberComponentCard.Body code={disableElCode} language="jsx" />
    </BooberComponentCard>

    <BooberComponentCard>
      <BooberComponentCard.Header title="Changing containers" light={false}>
        <p className="mt-2 mb-0">
      ...
      <BooberComponentCard.Body code={changingContainersCode} language="jsx" />
    </BooberComponentCard>
  </>
);
