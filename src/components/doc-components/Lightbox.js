...
import BooberLightBoxGallery from 'components/common/BooberLightBoxGallery';
import BooberLightBox from 'components/common/BooberLightBox';

const galleryCode = `<BooberLightBoxGallery images={images}>
  {setImgIndex => (
    <Row className="g-2">
      <Col xs={6}>
        <Image
...
</BooberLightBoxGallery>`;

const simpleImageCode = ` <BooberLightBox image={image}>
...
const Lightbox = () => {
  ...
  return (
    <>
      <PageHeader
        title="Lightbox"
        description="React-Boober uses <strong>React Image Lightbox</strong> for lightbox. React Image Lightbox is a flexible lightbox component for displaying images in a React project."
        className="mb-3"
      >
        <Button
      ...
      <BooberComponentCard>
        <BooberComponentCard.Header title="Gallery" />
        <BooberComponentCard.Body
          code={galleryCode}
          scope={{ BooberLightBoxGallery, images }}
          language="jsx"
        />
      </BooberComponentCard>

      <BooberComponentCard>
        <BooberComponentCard.Header title="Simple Image" />
        <BooberComponentCard.Body
          code={simpleImageCode}
          scope={{ BooberLightBox, image }}
          language="jsx"
        />
      </BooberComponentCard>
    </>
