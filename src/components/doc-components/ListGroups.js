...
const ListGroups = () => (
  <>
    ...
    <Row className="g-3 mb-3">
      ...
      <Col lg={6}>
        <BooberComponentCard noGuttersBottom>
          <BooberComponentCard.Header title="Active items" light={false} />
          <BooberComponentCard.Body code={activeExampleCode} language="jsx" />
        </BooberComponentCard>
      </Col>
    </Row>

    <BooberComponentCard>
      <BooberComponentCard.Header title="Actionable items" light={false}>
      ...
      <BooberComponentCard.Body code={actionableCode} language="jsx" />
    </BooberComponentCard>

    <Row className="g-3 mb-3">
      <Col lg={6}>
        <BooberComponentCard noGuttersBottom>
          <BooberComponentCard.Header title="List group flush" light={false}>
    ...
    <BooberComponentCard>
      <BooberComponentCard.Header title="Horizontal List Group" light={false}>
        <p className="mt-2 mb-0">
