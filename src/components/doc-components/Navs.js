...
const Navs = () => (
  <>
    ...
    <BooberComponentCard>
      <BooberComponentCard.Header title="Horizontal" light={false} />
      <BooberComponentCard.Body code={horizontalCode} language="jsx" />
    </BooberComponentCard>
    ...
    <BooberComponentCard>
      ...
      <BooberComponentCard.Body code={alignmentCode} language="jsx" />
    </BooberComponentCard>

    <BooberComponentCard>
      <BooberComponentCard.Header title="Vertical" light={false}>
        <p className="mt-2 mb-0">
      ...
      <BooberComponentCard.Body code={verticalCode} language="jsx" />
    </BooberComponentCard>

    <BooberComponentCard>
      <BooberComponentCard.Header title="Pills" light={false}>
        <p className="mt-2 mb-0">An alternative visual variant.</p>
      </BooberComponentCard.Header>
      <BooberComponentCard.Body code={pillsCode} language="jsx" />
    </BooberComponentCard>

    <BooberComponentCard multiSections>
      <Tab.Container defaultActiveKey="preview">
        <BooberComponentCard.Header title="Fill and justify" light={false}>
          <p className="mt-2 mb-0">
        ...
        <BooberComponentCard.Body code={fillsCode} language="jsx" />
      </Tab.Container>
      <Tab.Container defaultActiveKey="preview">
        <BooberComponentCard.Header>
          <p className="mt-2 mb-0">
        ...
        <BooberComponentCard.Body code={justifyCode} language="jsx" />
      </Tab.Container>
    </BooberComponentCard>

    <BooberComponentCard>
      <BooberComponentCard.Header title="Dropdowns" light={false} />
      <BooberComponentCard.Body code={dropdownsCode} language="jsx" />
    </BooberComponentCard>
  </>
);
