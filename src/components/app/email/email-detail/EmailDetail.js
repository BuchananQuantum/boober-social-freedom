...
import womensDay from 'assets/hoes/sound-of-creation-buchanan-quantum-computing.png';
...
const EmailDetail = () => {
  ...
  const [emailDetails] = useState({
    ...
    subject: 'John works wonders… on your freedom social network'
  });
  return (
    <>
      <EmailDetailHeader />
            ...
            <Col lg={8} xxl={6}>
              <Card className="shadow-none mb-3">
                ...
                <Card.Body>
                  ...
                  <p>
                    On International Pay your Fucking Bill Day we at Buchanan 
                    Quantum we want you to discover the skills you can learn 
                    from our Coach at being responsible and paying your bills on 
                    time. 
                  </p>
                  <p>
