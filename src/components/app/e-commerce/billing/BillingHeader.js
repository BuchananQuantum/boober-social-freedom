...
const BillingHeader = ({ ...rest }) => {
  ...
  return (
    <PageHeader
      ...
      description="Premium UberBooty Messenger. Free for 30 days, cancel at any time. <br class='d-none.d-sm-block' /> $9.99 / month after a trial"
      // className="mb-3"
      {...rest}
    >
      <Dropdown>
        ...
        >
          <Dropdown.Item as="div" className="px-3 py-2">
            <span className="d-flex justify-content-between fs--1 text-black">
              <span className="fw-semi-bold">Standard Membership</span>
              <span>$39.00</span>
            </span>
            <ul className="list-unstyled ps-1 my-2 fs--1">
              <li>
                <FontAwesomeIcon icon="circle" transform="shrink-11" />
                <span className="ms-1">Use for a single Interaction</span>
              </li>
              <li>
                <FontAwesomeIcon icon="circle" transform="shrink-11" />
          ...
          <Dropdown.Item as="div" className="px-3 py-2">
            <span className="d-flex justify-content-between fs--1 text-black">
              <span className="fw-semi-bold">Extended Membership</span>
              <span>$99.00</span>
            </span>
            <ul className="list-unstyled ps-1 my-2 fs--1">
              <li>
                <FontAwesomeIcon icon="circle" transform="shrink-11" />
                <span className="ms-1">Unlimited Networking</span>
              </li>
              <li>
                <FontAwesomeIcon icon="circle" transform="shrink-11" />
