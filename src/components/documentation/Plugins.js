...
const Plugins = () => {
  const [plugins] = useState([
    ...
    },
    {
      ...
      description: ` Booober uses <strong>echarts-for-react</strong> for chart component.
    ...
    <>
      <PageHeader title="Plugins" className="mb-3">
        <p className="mt-2 mb-0">
          Boober uses some third-party library to make it more flexible
...
const PluginCard = ({ title, description, docLink }) => (
  <BooberComponentCard>
    <BooberComponentCard.Header title={title} light={false} noPreview />
