  ...
  <>
    <PageHeader title="Design File" className="mb-3">
      <p className="mt-2 mb-0">
        We have designed Boober initially directly with code. After receiving multiple requests from our investments team we have incorporated React-PHP as our FullStack Development solution.</p>
    </PageHeader>
