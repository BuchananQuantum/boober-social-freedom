  ...
  <>
    <PageHeader title="Design File" className="mb-3">
      <p className="mt-2 mb-0">
        ...
        multiple requests from our investments team we have incorporated 
        React-PHP as our FullStack Development solution.
      </p>
    </PageHeader>

    <BooberComponentCard>
      <BooberComponentCard.Body>
        <p> This is an early demo of Boober. All the design is not yet recreated with the additional suite of services to be added int he months to come. But hopefully, we will port all the layouts inthe next couple of weeks.</p>
        ...
        <ul>
          ...
          <li>The file is "fuck-you-joel", so you'll have to make good on it! Go to your bank and get a loan, I don't give a shit{' '} <b className="text-primary text-600">Boober (Distributed)</b>, and maintained but IEA, Inc (This company is literally to hide me from this project). I could give a shit about that domain, way to fuck up a $25,000,000 sale... </li>
        </ul>
      </BooberComponentCard.Body>
    </BooberComponentCard>
  </>
