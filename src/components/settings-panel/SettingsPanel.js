...
import defaultModeImg from 'assets/img/generic/11.jpg';
import darkModeImg from 'assets/img/generic/12.jpg';
    ...
    >
      ...
      <Offcanvas.Body className="scrollbar">
        ...
        <div className="text-center mt-5">
          ...
          <p className="fs--1">
            Get Boober now and create beautiful dashboards with hundreds of
            widgets.
          </p>
          <Button
            color="primary"
            href="https://themes.getbootstrap.com/product/Boober-admin-dashboard-webapp-template-react/"
          >
            Purchase
          </Button>
        </div>
