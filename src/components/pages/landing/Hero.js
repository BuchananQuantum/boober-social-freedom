...
import dashboardDark from 'assets/hoes/holistic-hero-logo.png';
      ...
      <Row className="justify-content-center align-items-center pt-8 pt-lg-10 pb-lg-9 pb-xl-0">
        ...
        >
          ...
          <h1 className="text-white fw-light">
            Discover
            <Typed
              strings={['connections', 'networking', 'friendships', 'zero censorship']}
              typeSpeed={40}
              backSpeed={50}
          ...
          With the power of Boober, you can now focus only your interests and opinions, with the freedom of censorship.
          </p>
          <Button
            as={Link}
          ...
          >
            Start building your the Boober profile
