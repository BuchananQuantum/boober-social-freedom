...
const Display = () => (
  <>
    ...
    <BooberComponentCard>
      <BooberComponentCard.Header title="Notation" noPreview />
    ...
    <BooberComponentCard>
      <BooberComponentCard.Header title="Display in print">
        <p className="mt-2">
      ...
      <BooberComponentCard.Body code={displayInPrintCode} language="jsx" />
    </BooberComponentCard>
  </>
);
