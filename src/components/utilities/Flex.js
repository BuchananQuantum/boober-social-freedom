...
const Flexs = () => (
  <>
    ...
    <BooberComponentCard>
      <BooberComponentCard.Header title="Flex Behaviors">
        <p className="mt-2 mb-0">
          Apply Boober's <code> &lt;Flex&gt; </code> component to create a
    ...
    <BooberComponentCard multiSections>
      <Tab.Container defaultActiveKey="preview">
        <BooberComponentCard.Header title="Direction">
          <p className="mt-2 mb-0">
    ...
    <BooberComponentCard>
      <BooberComponentCard.Header title="Justify Content">
        <p className="mt-2 mb-0">
    ...
    <BooberComponentCard>
      <BooberComponentCard.Header title="Align items">
        <p className="mt-2 mb-0">
    ...
    <BooberComponentCard>
      <BooberComponentCard.Header title="Align self">
        <p className="mt-2 mb-0">
    ...
    <BooberComponentCard>
      <BooberComponentCard.Header title="Fill">
        <p className="mt-2 mb-0">
    ...
    <BooberComponentCard multiSections>
      <Tab.Container defaultActiveKey="preview">
        <BooberComponentCard.Header title="Grow and Shrink">
          <p className="mt-2 mb-0">
    ...
    <BooberComponentCard>
      <BooberComponentCard.Header title="Wrap">
        <p className="mt-2 mb-0">
    ...
    <BooberComponentCard>
      <BooberComponentCard.Header title="Align content">
        <p className="mt-2 mb-0">
