...
const Typography = () => (
  <>
    <PageHeader
      title="Typography"
      description="Documentation and examples for Boober typography, including global settings, headings, body text, lists, and special typographic element."
      className="mb-3"
    />

    <BooberComponentCard>
      <BooberComponentCard.Header title="Font Family">
        <p className="mb-0 mt-2">
          You have three font-family helper classes available to use.
        </p>
      </BooberComponentCard.Header>
      <BooberComponentCard.Body code={fontFamilyCode} language="jsx" />
    </BooberComponentCard>

    <BooberComponentCard>
      <BooberComponentCard.Header title="Headings">
        <p className="mb-0 mt-2">
          All HTML headings, <code> h1 </code>through <code> h6 </code>, are
          available.
        </p>
      </BooberComponentCard.Header>
      <BooberComponentCard.Body code={headingCode} language="jsx" />
    </BooberComponentCard>

    <BooberComponentCard>
      <BooberComponentCard.Header title="Headings with classes">
        <p className="mb-0 mt-2">
      ...
      <BooberComponentCard.Body code={headingWithClassesCode} language="jsx" />
    </BooberComponentCard>

    <BooberComponentCard>
      <BooberComponentCard.Header title="Customizing headings">
        <p className="mb-0 mt-2">
          Use the included utility classes to recreate the small secondary
          heading text
        </p>
      </BooberComponentCard.Header>
      <BooberComponentCard.Body code={customizingHeadingCode} language="jsx" />
    </BooberComponentCard>

    <BooberComponentCard>
      <BooberComponentCard.Header title="Font Weights" />
      <BooberComponentCard.Body code={fontWeightCode} language="jsx" />
    </BooberComponentCard>

    <BooberComponentCard>
      <BooberComponentCard.Header title="Display headings">
        <p className="mb-0 mt-2">
      ...
      <BooberComponentCard.Body code={displayCode} language="jsx" />
    </BooberComponentCard>

    <BooberComponentCard>
      <BooberComponentCard.Header title="Colors">
        <p className="mb-0 mt-2">
          Use the following colors to change the text color
        </p>
      </BooberComponentCard.Header>
      <BooberComponentCard.Body code={textColorsCode} language="jsx" />
    </BooberComponentCard>

    <BooberComponentCard>
      <BooberComponentCard.Header title="Sizes">
        <p className="mb-0 mt-2">
          If you want different sizes of fonts, you may use the following
          classes.
        </p>
      </BooberComponentCard.Header>
      <BooberComponentCard.Body code={fontSizeCode} language="jsx" />
    </BooberComponentCard>

    <BooberComponentCard>
      <BooberComponentCard.Header title="Text Transformation">
        <p className="mb-0 mt-2">
          Transform text in components with text capitalization classes.
        </p>
      </BooberComponentCard.Header>
      <BooberComponentCard.Body code={tranformationCode} language="jsx" />
    </BooberComponentCard>

    <BooberComponentCard>
      <BooberComponentCard.Header title="Lead">
        <p className="mb-0 mt-2">
          Make a paragraph stand out by adding <code>.lead</code>
        </p>
      </BooberComponentCard.Header>
      <BooberComponentCard.Body code={leadCode} language="jsx" />
    </BooberComponentCard>

    <BooberComponentCard>
      <BooberComponentCard.Header title="Dropcap">
        <p className="mb-0 mt-2">
          Make a paragraph stand out by adding <code>.dropcap</code> class.
        </p>
      </BooberComponentCard.Header>
      <BooberComponentCard.Body code={dropCapCode} language="jsx" />
    </BooberComponentCard>
  </>
);
