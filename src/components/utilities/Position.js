...
const Position = () => (
  <>
    ...
    <BooberComponentCard>
      <BooberComponentCard.Header title="Common values" noPreview>
        <p className="mt-2">
      ...
      <BooberComponentCard.Body>
        <BooberEditor code={commonCode} hidePreview className="p-2" />
      </BooberComponentCard.Body>
    </BooberComponentCard>

    <BooberComponentCard>
      <BooberComponentCard.Header title="Arrange Elements" light={false}>
      ...
      <BooberComponentCard.Body code={arrangElementsCode} language="jsx" />
    </BooberComponentCard>
    ...
    <BooberComponentCard>
      ...
      <BooberComponentCard.Body code={centerElementsCode} language="jsx" />
    </BooberComponentCard>
  </>
);
