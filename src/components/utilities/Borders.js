...
const Borders = () => (
  <>
    ...
    <Row className="mb-3 g-3">
      <Col md={6}>
        <BooberComponentCard noGuttersBottom>
          <BooberComponentCard.Header title="Additive" />
          <BooberComponentCard.Body
      ...
      <Col md={6}>
        <BooberComponentCard noGuttersBottom>
          <BooberComponentCard.Header title="Subtractive" />
          <BooberComponentCard.Body
    ...
    <BooberComponentCard>
      <BooberComponentCard.Header title="Border Radius">
    ...
    <BooberComponentCard>
      <BooberComponentCard.Header title="Border Sizes">
    ...
    <BooberComponentCard>
      <BooberComponentCard.Header title="Border Style">
        <p className="mb-0 mt-2">
    ...
    <BooberComponentCard>
      <BooberComponentCard.Header title="Border Width">
        <p className="mb-0 mt-2">
    ...
    <BooberComponentCard>
      <BooberComponentCard.Header title="Border Color">
        <p className="mt-2">
