...
const Sizing = () => (
  <>
    ...
    <BooberComponentCard>
      <BooberComponentCard.Header title="Width (relative to parent)" />
      <BooberComponentCard.Body code={sizingWidthCode} language="jsx" />
    </BooberComponentCard>

    <BooberComponentCard>
      <BooberComponentCard.Header title="Height (relative to parent)" />
      <BooberComponentCard.Body code={sizingHeightCode} language="jsx" />
    </BooberComponentCard>
