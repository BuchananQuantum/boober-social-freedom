...
const Grid = () => (
  <>
    ...
    <BooberComponentCard>
      <BooberComponentCard.Header title="Container">
      ...
      <BooberComponentCard.Body code={containerCode} language="jsx" />
    </BooberComponentCard>

    <BooberComponentCard multiSections>
      <Tab.Container defaultActiveKey="preview">
        <BooberComponentCard.Header title="Fluid Container">
          <p className="mt-1 mb-0">
            You can use <code>&lt;Container fluid /&gt;</code> for width: 100%
            across all viewport and device sizes.
          </p>
        </BooberComponentCard.Header>
        <BooberComponentCard.Body code={fluidCode} language="jsx" />
      </Tab.Container>
      <Tab.Container defaultActiveKey="preview">
        <BooberComponentCard.Header>
          <p className="mb-0">
        ...
        <BooberComponentCard.Body code={fluidBreakpointsCode} language="jsx" />
      </Tab.Container>
    </BooberComponentCard>

    <BooberComponentCard multiSections>
      <Tab.Container defaultActiveKey="preview">
        <BooberComponentCard.Header title="Column Width">
          <p className="mt-1 mb-0">
        ...
        <BooberComponentCard.Body code={columnWidthCode} language="jsx" />
      </Tab.Container>
      <Tab.Container defaultActiveKey="preview">
        <BooberComponentCard.Header>
          <p className="mb-0">
        ...
        <BooberComponentCard.Body code={widthAutoCode} language="jsx" />
      </Tab.Container>
    </BooberComponentCard>

    <BooberComponentCard multiSections>
      <Tab.Container defaultActiveKey="preview">
        <BooberComponentCard.Header title="Responsive grids">
          <p className="mt-2 mb-0">
        ...
        <BooberComponentCard.Body code={responsiveGridsCode} language="jsx" />
      </Tab.Container>
      <Tab.Container defaultActiveKey="preview">
        <BooberComponentCard.Header>
          <p className="mb-0">
    ...
    <BooberComponentCard>
      <BooberComponentCard.Header title="Order">
        <p className="mt-2 mb-0">
          You can use the <code>order</code> property to control the visual
          order of your content.
        </p>
      </BooberComponentCard.Header>
      <BooberComponentCard.Body code={orderCode} language="jsx" />
    </BooberComponentCard>

    <BooberComponentCard>
      <BooberComponentCard.Header title="Offset">
        <p className="mt-2 mb-0">
      ...
      <BooberComponentCard.Body code={offsetCode} language="jsx" />
    </BooberComponentCard>

    <BooberComponentCard>
      <BooberComponentCard.Header title="Setting column widths in Row">
        <p className="mt-2 mb-0">
      ...
      <BooberComponentCard.Body code={columnWidthInRowCode} language="jsx" />
    </BooberComponentCard>
  </>
);
