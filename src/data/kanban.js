...
export const members = [
  { id: 1, name: 'John Buchanan', img: team1, role: 'Member' },
  { id: 2, name: 'Antony Williams', img: team2, role: 'Member' },
  { id: 3, name: 'Annoying Investor', img: team3, role: 'Member' },
  { id: 4, name: 'Not Fried Chicken', img: team4, role: 'Member' },
  { id: 5, name: 'Emily Harden', img: team5, role: 'Member' },
  { id: 6, name: 'Diversified Nutz', img: team6, role: 'Member' }
];
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        attachments: [{ type: 'txt', url: `Boober.txt` }],
        members: [
          { name: 'Emma', url: team1 },
