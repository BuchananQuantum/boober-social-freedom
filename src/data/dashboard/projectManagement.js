...
export const projectsTable = [
  ...
  {
    id: 2,
    project: 'UberBooty Messenger',
    team: 'The Dream team',
    iconColor: 'text-warning'
  },
  {
    id: 3,
    project: 'UberWeed | Dispensary Management',
    team: 'John Buchanan',
    iconColor: 'text-secondary'
  },
  {
    id: 4,
    project: 'Investment Team Mental Evaulation',
    team: 'https://betterhelp.com',
    iconColor: 'text-info'
  }
];
...
export const managementEvents = [
  {
    id: uuid(),
    title: `Monthly team meeting for Jokes on Joel App`,
    ...
    extendedProps: {
      description:
        'Tony Williams, Now in partnership with the John Buchanan, Ionic Enteprise Apps.',
      location:
        'Atlantic City Board Walk, </br> Atlantic City, NJ 02109, United States',
      organizer: 'Buchanan Quantum'
    },
    display: 'background',
    color: 'primary',
...
export const recentActivities = [
  {
    id: 0,
    title: 'Anthony Williams sent an Email',
  ...
  {
    id: 2,
    title: 'Buchanan Quantum v3.0.0 released algorithm with Ethereum',
    text: 'Do you know how much work it takes to get all this fake data into this for the worst client ever?',
    icon: 'code',
    time: '1h ago',
    status: 'current'
  },
  {
    id: 3,
    title: 'Seriously, this shit is so old',
    text: 'Do you know how much work it takes to get all this fake data into this for the worst client ever?',
    icon: 'code-branch',
    time: '3h ago',
    status: false
